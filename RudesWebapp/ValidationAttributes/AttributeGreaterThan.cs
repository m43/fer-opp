...
namespace RudesWebapp.ValidationAttributes
{
    ...
    // Modified from: https://stackoverflow.com/questions/19882296/mvc4-data-annotation-compare-two-dates
    public class AttributeGreaterThan : ValidationAttribute
    {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            return currentValue.CompareTo((IComparable) comparisonValue) > 0
