	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\begin{figure}[H]
						\includegraphics[scale=0.4]{dijagrami/Funkcionalnosti korisnika i klijenta.PNG}
						\centering
					...
					\begin{figure}[H]
						\includegraphics[scale=0.4]{dijagrami/Funkcionalnosti trenera.PNG}
						\centering
					...
					\begin{figure}[H]
						\includegraphics[scale=0.4]{dijagrami/Funkcionalnosti člana uprave.PNG}
						\centering
					...
					\begin{figure}[H]
						\includegraphics[scale=0.4]{dijagrami/Funkcionalnosti administratora.PNG}
						\centering
			...
			\subsection{Sekvencijski dijagrami}
				...
				\begin{figure}[H]
					\includegraphics[scale=0.4]{dijagrami/UC10 Stavljanje artikla u košaricu.PNG}
					\centering
				...
				\begin{figure}[H]
					\includegraphics[scale=0.4]{dijagrami/UC15 Plaćanje.PNG}
					\centering
				...
				\begin{figure}[H]
					\includegraphics[scale=0.4]{dijagrami/UC21 Uređivanje artikala u web shopu.PNG}
					\centering
